...
surface_snap.set_pos(flx*0.06, fly*0.2, flw*0.5, flh*0.5245);
...
{
local listbox = fe.add_listbox( flx*0.7, fly*0.087, flw*0.295, flh*0.84 );
listbox.rows = 30;
listbox.charsize = 23;
...
//Title text info
local textt = fe.add_text( "[Title]", flx*0.018, fly*0.04, flw*0.56, flh*0.05  );
textt.set_rgb( 0, 0, 0 );
...
local textgc = fe.add_text( "Game Count: [ListEntry]-[ListSize]", flx*0.179, fly*0.895, flw*0.4, flh*0.04  );
...
textf.set_rgb( 0, 0, 0 );
//textf.style = Style.Bold;
textf.align = Align.Left;
textf.rotation = 0;
textf.word_wrap = true;

//Year text info
local texty = fe.add_text("Year: [Year]", flx*2.21, fly*0.876, flw*0.2, flh*0.04 );
texty.set_rgb( 0, 0, 0 );
...
//Emulator text info
local textemu = fe.add_text( "[DisplayName]", flx*2.2, fly*0.03, flw*0.6, flh*0.08  );
